...
StompClient: bin/connectionHandler.o bin/clientDataBase.o bin/keyboardReader.o bin/protocol.o bin/socketReader.o bin/stompBookClubClient.o
	...
	g++ -pthread -o bin/stompBookClubClient bin/stompBookClubClient.o bin/clientDataBase.o bin/keyboardReader.o bin/protocol.o bin/socketReader.o bin/connectionHandler.o $(LDFLAGS)
